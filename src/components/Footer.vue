  ...
  <footer class="bg-white" aria-labelledby="footer-heading">
    ...
    <div class="mx-auto max-w-7xl px-6 pb-8 pt-16 sm:pt-24 lg:px-8 lg:pt-32">
      <div class="xl:grid xl:grid-cols-3 xl:gap-8">
        <div class="space-y-8">
          <img class="h-20"  src="/img/logo_fond_blanc.png" alt="Logo Toul'Barz" />
          <div>
            <p class="text-sm leading-6 text-gray-600">Toul'Barz est un club associatif de Street Workout situé au coeur de Toulouse, ayant pour but de développer et officialiser la pratique du Street Workout.</p>
          </div>
      ...
      <div class="mt-16 border-t border-gray-900/10 pt-8 sm:mt-20 lg:mt-24">
        <p class="text-xs leading-5 text-gray-500">&copy; 2024 Toul'Barz, tous droits réservés.</p>
      </div>
    </div>
  </footer>
</template>
